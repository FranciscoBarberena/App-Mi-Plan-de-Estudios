...
object DataDisenoComunicacionVisual : _InformacionDeCarrera {
    ...
    override val reglasDeCorrelatividadesFinalConCursada = mapOf(
        ...
        25 to listOf(15, 16, 19),      // DCV V -> Final Teoría, Mercadotecnia, DCV IV
        26 to listOf(12, 14),          // Legislación -> Final DCV III, Tecno III
        27 to listOf(5, 17),           // Hist Arg -> Final Panorama, Textos
        28 to listOf(12, 15, 18),      // Optativa III -> Final DCV III, Teoría, Optativa II
        29 to listOf(12, 15, 18) ,      // Optativa IV -> Final DCV III, Teoría, Optativa II
    ...
    override val reglasDeCorrelatividadesFinalConFinal = reglasDeCorrelatividadesFinalConCursada + mapOf(
        ...
        26 to (reglasDeCorrelatividadesFinalConCursada[26]?.plus(listOf(12,14)) ?: emptyList()),
        27 to (reglasDeCorrelatividadesFinalConCursada[27   ]?.plus(listOf(5,17)) ?: emptyList()),
    )
