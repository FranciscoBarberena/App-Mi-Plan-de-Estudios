...
object DataDisenoIndustrial : _InformacionDeCarrera {
    ...
    override val reglasDeCorrelatividadesCursadaConCursada = mapOf(
        ...
        27 to listOf(22, 24, 23),  // Taller 5 -> Tecno 4, Hist Dis, Economia
        28 to listOf(22, 26),      // Tecno 5 -> Tecno 4, Fis 2
        29 to listOf(23, 24),      // Gestion -> Economia, Hist Dis
        30 to emptyList(),         // Sem Opt 3 -> (Ver FinalConCursada)
    ...
    override val reglasDeCorrelatividadesFinalConCursada = mapOf(
        ...
        27 to listOf(21, 14, 15, 18), // Taller 5 -> Final Taller 4, Tecno 3, Sist Forma, Dis y Cult
        28 to listOf(14, 13, 20),  // Tecno 5 -> Final Tecno 3, Taller 3, Fis 1
        29 to listOf(16, 18),      // Gestion -> Final Metodos 2, Dis y Cult
        30 to listOf(25),          // Sem Opt 3 -> Final Sem Opt 2
    ...
    override val reglasDeCorrelatividadesFinalConFinal = mapOf(
        ...
        27 to listOf(21, 14, 15, 18), // Taller 5 -> Taller 4, Tecno 3, Sist Forma, Dis y Cult
        28 to listOf(14, 13, 20),  // Tecno 5 -> Tecno 3, Taller 3, Fis 1
        29 to listOf(16, 18),      // Gestion -> Metodos 2, Dis y Cult
        30 to listOf(25),          // Sem Opt 3 -> Sem Opt 2
        31 to listOf(25)           // Sem Opt 4 -> Sem Opt 2
    )
