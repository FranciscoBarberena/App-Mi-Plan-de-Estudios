...
object DataLicenciaturaEnArtesPlasticas : _InformacionDeCarrera {
    override val nombresDeMaterias = arrayOf(
        ...
        "Legislación y política cultural",         // 26 (H0070)
        "Historia de las artes visuales 4",        // 27 (H0008)
        "Seminario a elección 1",                  // 28 (00010)
        "Seminario a elección 2",                  // 29 (P0049/Alt)
        "Taller de trabajo de graduación"          // 30 (P0049)
    )
    ...
    override val reglasDeCorrelatividadesFinalConCursada = mapOf(
        ...
        26 to emptyList(),
        27 to emptyList(),
        28 to listOf(11, 14, 9),
        29 to listOf(28),
        30 to listOf(15,19,21,20,18)
    ...
    override val reglasDeCorrelatividadesFinalConFinal = mapOf(
        ...
        26 to listOf(25),
        27 to listOf(24),
        28 to listOf(11, 14, 16),
        29 to listOf(28),
        30 to listOf(15,19,21,20,18,23)
    )
